...
def voxel_labelling_MC_test(nevent, df, total_size, steps = None, x0 = None):
    ...
    voxel_id, voxel_ener, voxel_portion = voxel_labelling_MC(img, mccoors, mcenes, hits_id, bins)
